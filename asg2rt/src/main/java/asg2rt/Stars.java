...
public class Stars {
    ...
    public List<ReturnData> showAcc1() {
        ...
        try {
            ...
            final List<ReturnData> statistic = new ArrayList<ReturnData>();
            ...
            for (final Element nameFollower : name) {
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        statistic.add(new ReturnData(nameFollower.text(), repo.text(), followers.text(), stars.text(), following.text()));
                    }
                });
                thread.start();
                try {
